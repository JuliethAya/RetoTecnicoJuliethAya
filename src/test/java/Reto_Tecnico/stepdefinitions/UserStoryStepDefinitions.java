...
public class UserStoryStepDefinitions {
    ...
    public void Entertheregistrationoption() {
        OnStage.theActorCalled("Julieth").wasAbleTo(Openup.thePage());
    }
    ...
    public void Entertheformdata(List<RegistrationData> data)
            throws Exception {
        OnStage.theActorInTheSpotlight().attemptsTo(Dataentrystepone.thepage(data), Dataentrysteptwo.thepage(data), Dataentrystepthree.thepage(data), Dataentrystepfour.thepage(data), UserRegistration.thepage(data));
    }
